...
namespace Ticari_Otomasyon {
    ...
    public partial class Dbo_TicariOtomasyonDataSet1 : global::System.Data.DataSet {
        ...
        public partial class Tbl_MusterilerDataTable : global::System.Data.TypedTableBase<Tbl_MusterilerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public Tbl_MusterilerRow AddTbl_MusterilerRow(string AD, string SOYAD, string TELEFON, string TELEFON2, string TC, string IL, string ILCE, string ADRES, string VERGIDAIRESI) {
            ...
            public string VERGIDAIRESI {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'Tbl_Musteriler\' tablosundaki \'VERGIDAIRESI\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace Ticari_Otomasyon.Dbo_TicariOtomasyonDataSet1TableAdapters {
    ...
    public partial class Tbl_MusterilerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Tbl_Musteriler] ([AD], [SOYAD], [TELEFON], [TELEFON2], [TC], [IL], [ILCE], [ADRES], [VERGIDAIRESI]) VALUES (@AD, @SOYAD, @TELEFON, @TELEFON2, @TC, @IL, @ILCE, @ADRES, @VERGIDAIRESI);
SELECT ID, AD, SOYAD, TELEFON, TELEFON2, TC, IL, ILCE, ADRES, VERGIDAIRESI FROM Tbl_Musteriler WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Tbl_Musteriler] SET [AD] = @AD, [SOYAD] = @SOYAD, [TELEFON] = @TELEFON, [TELEFON2] = @TELEFON2, [TC] = @TC, [IL] = @IL, [ILCE] = @ILCE, [ADRES] = @ADRES, [VERGIDAIRESI] = @VERGIDAIRESI WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@IsNull_SOYAD = 1 AND [SOYAD] IS NULL) OR ([SOYAD] = @Original_SOYAD)) AND ((@IsNull_TELEFON = 1 AND [TELEFON] IS NULL) OR ([TELEFON] = @Original_TELEFON)) AND ((@IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)) AND ((@IsNull_TC = 1 AND [TC] IS NULL) OR ([TC] = @Original_TC)) AND ((@IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_VERGIDAIRESI = 1 AND [VERGIDAIRESI] IS NULL) OR ([VERGIDAIRESI] = @Original_VERGIDAIRESI)));
SELECT ID, AD, SOYAD, TELEFON, TELEFON2, TC, IL, ILCE, ADRES, VERGIDAIRESI FROM Tbl_Musteriler WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, SOYAD, TELEFON, TELEFON2, TC, IL, ILCE, ADRES, VERGIDAIRESI FROM d" +
                "bo.Tbl_Musteriler";
        ...
        public virtual int Fill(Dbo_TicariOtomasyonDataSet1.Tbl_MusterilerDataTable dataTable) {
        ...
        public virtual Dbo_TicariOtomasyonDataSet1.Tbl_MusterilerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Dbo_TicariOtomasyonDataSet1.Tbl_MusterilerDataTable dataTable = new Dbo_TicariOtomasyonDataSet1.Tbl_MusterilerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Dbo_TicariOtomasyonDataSet1.Tbl_MusterilerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_AD, string Original_SOYAD, string Original_TELEFON, string Original_TELEFON2, string Original_TC, string Original_IL, string Original_ILCE, string Original_ADRES, string Original_VERGIDAIRESI) {
        ...
        public virtual int Insert(string AD, string SOYAD, string TELEFON, string TELEFON2, string TC, string IL, string ILCE, string ADRES, string VERGIDAIRESI) {
            if ((AD == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_ADRES, 
                    string Original_VERGIDAIRESI) {
            return this.Update(AD, SOYAD, TELEFON, TELEFON2, TC, IL, ILCE, ADRES, VERGIDAIRESI, Original_ID, Original_AD, Original_SOYAD, Original_TELEFON, Original_TELEFON2, Original_TC, Original_IL, Original_ILCE, Original_ADRES, Original_VERGIDAIRESI, Original_ID);
        }
    }
