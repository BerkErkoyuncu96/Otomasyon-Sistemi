...
namespace Ticari_Otomasyon {
    ...
    public partial class Dbo_TicariOtomasyonDataSet3 : global::System.Data.DataSet {
        ...
        public partial class Tbl_PersonellerDataTable : global::System.Data.TypedTableBase<Tbl_PersonellerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public Tbl_PersonellerRow AddTbl_PersonellerRow(byte ID, string AD, string SOYAD, string TELEFON, string TC, string MAIL, string IL, string ILCE, string ADRES, string DEPARTMAN) {
        ...
        public partial class Tbl_PersonellerRow : global::System.Data.DataRow {
            ...
            public string DEPARTMAN {
                get {
                    try {
                        return ((string)(this[this.tableTbl_Personeller.DEPARTMANColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("\'Tbl_Personeller\' tablosundaki \'DEPARTMAN\' sütunun değeri DBNull.", e);
                    }
                }
                set {
                    this[this.tableTbl_Personeller.DEPARTMANColumn] = value;
                }
            }
            ...
            public bool IsDEPARTMANNull() {
                return this.IsNull(this.tableTbl_Personeller.DEPARTMANColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetDEPARTMANNull() {
                this[this.tableTbl_Personeller.DEPARTMANColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Ticari_Otomasyon.Dbo_TicariOtomasyonDataSet3TableAdapters {
    ...
    public partial class Tbl_PersonellerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Tbl_Personeller] ([AD], [SOYAD], [TELEFON], [TC], [MAIL], [IL], [ILCE], [ADRES], [DEPARTMAN]) VALUES (@AD, @SOYAD, @TELEFON, @TC, @MAIL, @IL, @ILCE, @ADRES, @DEPARTMAN);
SELECT ID, AD, SOYAD, TELEFON, TC, MAIL, IL, ILCE, ADRES, DEPARTMAN FROM Tbl_Personeller WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Tbl_Personeller] SET [AD] = @AD, [SOYAD] = @SOYAD, [TELEFON] = @TELEFON, [TC] = @TC, [MAIL] = @MAIL, [IL] = @IL, [ILCE] = @ILCE, [ADRES] = @ADRES, [DEPARTMAN] = @DEPARTMAN WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@IsNull_SOYAD = 1 AND [SOYAD] IS NULL) OR ([SOYAD] = @Original_SOYAD)) AND ((@IsNull_TELEFON = 1 AND [TELEFON] IS NULL) OR ([TELEFON] = @Original_TELEFON)) AND ((@IsNull_TC = 1 AND [TC] IS NULL) OR ([TC] = @Original_TC)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_DEPARTMAN = 1 AND [DEPARTMAN] IS NULL) OR ([DEPARTMAN] = @Original_DEPARTMAN)));
SELECT ID, AD, SOYAD, TELEFON, TC, MAIL, IL, ILCE, ADRES, DEPARTMAN FROM Tbl_Personeller WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, SOYAD, TELEFON, TC, MAIL, IL, ILCE, ADRES, DEPARTMAN FROM dbo.Tbl_" +
                "Personeller";
        ...
        public virtual int Delete(byte Original_ID, string Original_AD, string Original_SOYAD, string Original_TELEFON, string Original_TC, string Original_MAIL, string Original_IL, string Original_ILCE, string Original_ADRES, string Original_DEPARTMAN) {
            ...
            if ((Original_DEPARTMAN == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[18].Value = ((string)(Original_DEPARTMAN));
            }
        ...
        public virtual int Insert(string AD, string SOYAD, string TELEFON, string TC, string MAIL, string IL, string ILCE, string ADRES, string DEPARTMAN) {
            if ((AD == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_DEPARTMAN == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((string)(Original_DEPARTMAN));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_ADRES, 
                    string Original_DEPARTMAN) {
            return this.Update(AD, SOYAD, TELEFON, TC, MAIL, IL, ILCE, ADRES, DEPARTMAN, Original_ID, Original_AD, Original_SOYAD, Original_TELEFON, Original_TC, Original_MAIL, Original_IL, Original_ILCE, Original_ADRES, Original_DEPARTMAN, Original_ID);
        }
    }
